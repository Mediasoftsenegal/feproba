            ...
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    ...
                    <!-- inbox dropdown start-->
						<a href="menu_ve.php?page=tab_vente"><button type="button" class="btn btn-theme01"><i class="fa fa-th"></i> Etat des vente </button></a>
						<a href="menu_ve.php?page=recap_ventes"><button type="button" class="btn btn-theme02"><i class="fa fa-book"></i> Statistiques </button></a>
						<a href="menu_ve.php?page=table_dispo"><button type="button" class="btn btn-theme05"><i class="fa fa-book"></i> Disponibilté </button></a>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class='sub-menu'>
					...
					<span>Gestion du stock</span>
						...
						<ul class='sub'>
							<li><a href='menu_ve.php?page=tab_vente'><i class='fa fa-th'></i>Etat des vente</a></li>
							<li><a href='menu_ve.php?page=recap_ventes'><i class='fa fa-bar-chart-o'></i>Statistiques</a></li>
							<li><a href='menu_ve.php?page=table_dispo'><i class='fa fa-bar-chart-o'></i>Disponibilté</a></li>

          ...
          <section class="wrapper">          	
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>  Formulaire nature de parcelle</h4>
					  ...
					  <div class="col-lg-6">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
								  <input type="hidden" name="etat" value="varieteajout";>
								  <input type="hidden" name="modif" value="0";>
								  <input type="text" name="nom_variete" class="form-control">
                              </div>
                          </div>
                         </div>
                          <div class="col-lg-3"></div>
